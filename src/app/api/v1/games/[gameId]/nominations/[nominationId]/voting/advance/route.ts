...
import { advanceVotingPass } from "@/modules/investigation/investigation.service";
...
export async function POST(
  ...
  try {
    ...
    const { version } = await advanceVotingPass({ gameId, nominationId, commandId, expectedVersion });
